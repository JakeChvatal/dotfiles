...
(setq org-attach-id-dir "~/Dropbox/org/.attach/") ;; the former may be aliased to this, safer to set both
...
;; use full path for refile target
...
;; Tasks can't be done if subtasks are not
